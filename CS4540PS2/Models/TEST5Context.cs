...
namespace CS4540PS2.Models
{
    public partial class TEST5Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=TEST5;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CourseInstance>(entity =>
            {
                entity.HasIndex(e => new { e.Department, e.Number, e.Semester, e.Year })
                    .HasName("UQ__CourseIn__EA334D09A309E97C")
                    .IsUnique();
            ...
            modelBuilder.Entity<CourseNotes>(entity =>
            {
                entity.HasKey(e => e.NoteId)
                    .HasName("PK__CourseNo__EACE355FA580C04F");
            ...
            modelBuilder.Entity<CourseStatus>(entity =>
            {
                entity.HasKey(e => e.StatusId)
                    .HasName("PK__CourseSt__C8EE2043379C1703");
            ...
            modelBuilder.Entity<Departments>(entity =>
            {
                entity.HasKey(e => e.Code)
                    .HasName("PK__Departme__A25C5AA6093E54F2");
            ...
            modelBuilder.Entity<EvaluationMetrics>(entity =>
            {
                entity.HasKey(e => e.Emid)
                    .HasName("PK__Evaluati__258EC8E093336766");
            ...
            modelBuilder.Entity<Instructors>(entity =>
            {
                entity.HasKey(e => e.Ikey)
                    .HasName("PK__Instruct__8D7A08C6FB689512");

                entity.HasIndex(e => new { e.CourseInstanceId, e.UserId })
                    .HasName("UQ__Instruct__E0CD20A34FCF9758")
                    .IsUnique();
            ...
            modelBuilder.Entity<LearningOutcomes>(entity =>
            {
                entity.HasKey(e => e.Loid)
                    .HasName("PK__Learning__76F319DDD784FCE0");
            ...
            {
                entity.HasKey(e => e.NoteId)
                    .HasName("PK__LONotes__EACE355F398CB71B");
            ...
            modelBuilder.Entity<Notifications>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Notifica__1788CCAC0966B616");
            ...
            modelBuilder.Entity<SampleFiles>(entity =>
            {
                entity.HasKey(e => e.Sid)
                    .HasName("PK__SampleFi__CA1959705A430BB1");
